...
func NewEchoServer() Server {
	...
	accountGroup.POST("/:acc_id/withdraw_topup", api_v1.CreateSelfTransaction, auth.JWTMiddleware())
	...
	staffGroup.DELETE("/undo/:acc_id", api_v1.UndoRecentTransactions, auth.JWTMiddleware())
